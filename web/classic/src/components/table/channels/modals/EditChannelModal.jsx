...
const EditChannelModal = (props) => {
  ...
  const submit = async () => {
    ...
    if (localInputs.sampling_interval_seconds === '' || localInputs.sampling_interval_seconds === undefined) {
      ...
      const val = parseInt(localInputs.sampling_interval_seconds, 10);
      localInputs.sampling_interval_seconds = isNaN(val) ? null : val;
    }
                  ...
                  {isAdmin() && (
                    <div className='pt-4 border-t border-gray-100 mt-4'>
                      ...
                      <Form.Input
                        ...
                        min={1}
                        onChange={(value) =>
                          handleInputChange('sampling_interval_seconds', value)
                        }
                        showClear
                        extraText={t(
                      ...
                      <div className='text-xs text-gray-500 mt-1 mb-2'>
                        {t('建议：付费 API 1~5 秒，免费/限流 API 10~30 秒')}
                      </div>
                    </div>
                  )}
                </div>
