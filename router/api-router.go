...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		apiRouter.GET("/rankings", middleware.AdminAuth(), controller.GetRankings)
		...
		channelFlowRoute.Use(middleware.AdminAuth())
		{
			...
			channelFlowRoute.GET("/pools/:id/distribution", controller.GetChannelFlowPoolDistribution)
		...
		logRoute.POST("/backup", middleware.AdminAuth(), controller.TriggerLogBackup)
		...
		dataRoute.GET("/users/export", middleware.AdminAuth(), controller.ExportUserQuotaData)
		dataRoute.GET("/models", middleware.UserAuth(), controller.GetEnabledPublicModels)
