...
func SetRelayRouter(router *gin.Engine) {
	...
	playgroundRouter.Use(middleware.SessionId())
	...
	relayV1Router.Use(middleware.SessionId())
	...
	relayMjRouter.Use(middleware.SessionId())
	relayMjRouter.Use(middleware.SystemPerformanceCheck())
	registerMjRouterGroup(relayMjRouter)

	relayMjModeRouter := router.Group("/:mode/mj")
	relayMjModeRouter.Use(middleware.RouteTag("relay"))
	relayMjModeRouter.Use(middleware.SessionId())
	...
	relaySunoRouter.Use(middleware.SessionId())
	...
	relayGeminiRouter.Use(middleware.SessionId())
